...
_COCO_LABELS_FILE = './mask-rcnn-coco/object_detection_classes_coco.txt'
_COCO_COLORS_FILE = './mask-rcnn-coco/colors.txt'
_COCO_WEIGHTS_FILE = './mask-rcnn-coco/frozen_inference_graph.pb'
_COCO_CONFIG_FILE = './mask-rcnn-coco/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt'
